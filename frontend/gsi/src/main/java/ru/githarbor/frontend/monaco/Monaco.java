...
public class Monaco {
    ...
    public static native Promise<String> colorize(String text, String langId);

    @JsMethod(name = "editor.colorizeModelLine")
    public static native String colorizeModelLine(ITextModel model, double lineNumber);
    ...
    @JsMethod(name = "languages.onLanguage")
    public static native Disposable onLanguage(String langId, OnLanguage onLanguage);
